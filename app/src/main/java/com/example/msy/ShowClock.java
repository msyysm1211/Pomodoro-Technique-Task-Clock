...
//        reset.setTag(1,intentmusic);
        reset.addTextChangedListener(new TextWatcher() {//监听按钮时间的变化
            ...
            public void afterTextChanged(Editable s) {
              ...
              /*  Intent intentmusic = new Intent(test.this, MyIntentService.class);//音乐播放
                String action = MyIntentService.ACTION_MUSIC;
                intentmusic.setAction(action);*/
                MediaPlayer  mediaPlayer;
                mediaPlayer=MediaPlayer.create(ShowClock.this,R.raw.music);
                mediaPlayer.setLooping(true);
        ...
        exit.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(ShowClock.this,MyIntentService.class);//关闭背景音乐
                stopService(intent2);

                Intent intent = new Intent(ShowClock.this,NavigationTest.class);
